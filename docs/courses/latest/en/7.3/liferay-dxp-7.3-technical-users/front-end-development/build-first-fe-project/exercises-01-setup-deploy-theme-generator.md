...
1. **Go to** [https://nodejs.org/download/release/v10.18.1/](https://nodejs.org/download/release/v10.18.1/).
...
_Note: It is possible you may run into errors with the latest LTS version of Node. To avoid this, we recommend using Node version 10.18.1 as shown above._
...
<img src="images/get_me_out_of_here.png" style="max-width:95%;" />
...
<img src="images/activation_deployed.png" style="max-width:95%;" />
...
5. **Choose** _7.3_  for the _version_.
...
<img src="images/base_theme_test.png" style="max-width:80%;" />
